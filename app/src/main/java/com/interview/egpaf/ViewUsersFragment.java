...
public class ViewUsersFragment extends Fragment {
     ...
     * @return A new instance of fragment ViewUsersFragment.
     */
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) view.findViewById(R.id.viewUserRecyclerView);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));

        adapter = new UserViewAdapter(databaseHelper.getAllUsers(),getActivity());
